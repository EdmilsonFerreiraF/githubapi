...
const SearchList = () => {
    ...
    const result = useRequestData(`${GITHUB_API_URL}/search/users?q=${query.get("query")}`, [])
    ...
    return (
        <div className="my-5 gy-3 row">
            ...
            {!query.get("query") && <p className="text-center lead">Pesquise por usuário, repositório ou repositórios mais visitados no campo de pesquisa</p>}
